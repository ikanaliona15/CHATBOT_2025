...
def configurar_pagina():
    st. set_page_config(page_title="El chat de Alu", page_icon="✨")
    st.title("El chat de Alu")
    st.sidebar.title("Selección de modelos")
    elegirModelo = st.sidebar.selectbox("Elegí un modelo", options=MODELOS, index=0, key="modelo_selectbox_1")
    return elegirModelo
